...
config_dir = ("/home/jonas/.config/awesome/")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "HOME", "EMACS", "DOCS", "MEDIA", "CHAT"}, s, layouts[1])
end
-- }}}
...
kbdcfg.switch = function ()
 ...
 -- Mouse bindings for keyboard change
...
local strf = '<span font="' .. font .. '" color="#FFFFFF" background="#777E76">%b%d %I:%M</span>'
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    if args["{wlan0 carrier}"] == 1 then
        interface = "wlan0"
    elseif args["{eno1 carrier}"] == 1 then
        interface = "eno1"
    else
        return ""
    end
    return '<span background="#C2C2A4" font="Inconsolata 12"><span font ="Inconsolata 12" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
-- vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 12"><span font="Inconsolata 12" color="#FFFFFF" background="#92B0A0">$1$2%</span></span>', 30, "BAT0" )
...
-- '<span background="#D0785D" font="Inconsolata 12"> <span font="Inconsolata 12" color="#EEEEEE">${/home used_gb}/${/home avail_gb} GB </span></span>',
'<span background="#D0785D" font="Inconsolata 12"><span font="Inconsolata 12" color="#EEEEEE">${/ used_gb}</span></span>',
800)
...
'<span background="#4B3B51" font="Inconsolata 12"><span font="Inconsolata 12" color="#EEEEEE">$1</span></span>', 0.3, "Master")
...
'<span background="#4B696D" font="Inconsolata 12"><span font="Inconsolata 12" color="#DDDDDD">$1%</span></span>', 5)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="Inconsolata 12"><span font="Inconsolata 12" color="#EEEEEE" background="#777E76">$2MB</span></span>', 20)
...
-- {{ Shuts down Computer }} --
    ...
    awful.key({ modkey, "Shift"   }, "Delete", function() awful.util.spawn("systemctl poweroff") end),
...
-- {{ ergo controls:
    ...
    -- screens
    awful.key({modkey,          }, "F11",    function () awful.screen.focus_relative( -1) end),
    awful.key({modkey,          }, "F12",    function () awful.screen.focus_relative( 1) end),
    awful.key({modkey,          }, "#" .. 90,    function () awful.screen.focus_relative( 1) end),

    -- awful.key({ "Alt",            }, "Tab", function () awful.screen.focus_relative( 1) end),
