...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = { /* Qwerty */
    ...
    {LT(_FN, KC_TAB), KC_A,  KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,  KC_SCLN,   KC_ENT},
    { KC_LSFT,     KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,  KC_COMM,   KC_DOT,  KC_SLSH, SFT_T(KC_QUOT)},
    { KC_LCTL, ________,  KC_LGUI,  KC_LALT,  KC_LCTL,     LALT(KC_M),   LT(_HIGH, KC_SPC),
      MO(_LOW),  KC_RALT,  KC_RGUI, ________, KC_RCTL}
    },

    [_HIGH] = {
      {  KC_GRV, ________, ________, ________, ________, ________, ________, ________,  KC_LBRC,  KC_RBRC,   KC_DEL,  KC_BSPC},
    ...
    [_FN] = {
      ...
      {   RESET,     M(0),  KC_LGUI,  KC_LALT,  KC_LCTL, KC_SPC,     KC_SPC, ________, ________, ________, ________, KC_LCTL}
    },

    [_LOW] = {
      {   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F11,   KC_F12},
      { KC_EXLM,    KC_AT,  KC_HASH,   KC_DLR,  KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_UNDS,  KC_PLUS},
      {________, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5), LGUI(KC_F12), ________, ________, ________, ________, ________},
      { KC_LCTL, ________,  KC_LGUI,  KC_LALT,  KC_LCTL,  KC_RALT,  KC_TRNS,  KC_TRNS,  KC_RALT,  KC_RGUI, ________,  KC_RCTL}
    },
    /*
      [_EXTRA] = {
